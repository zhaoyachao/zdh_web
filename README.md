...
## 基础环境
    ...
    2 jdk1.8 (不支持jdk8以上的版本)
    3 v5.5.0版本及之后至少需要jdk1.8, springboot版本升级为2.3.4版本
...
# 交流群
<img src="img/qq.jpg" alt="qq" width="300" height="400">

# 支持&赞赏
   如果当前项目对你有帮助或者提供便利, 你的赞赏会给作者带来更多的动力  
<img src="img/vx打赏.jpg" alt="vx" width="300" height="400">
