...
@Table(name = "etl_task_unstructure_log_info")
public class EtlTaskUnstructureLogInfo {
    @Id
    private String id;
     ...
     * 获取非结构化任务ID
     *
     * @return unstructure_id - 非结构化任务ID
     */
    public String getUnstructure_id() {
        return unstructure_id;
    }

    /**
     * 设置非结构化任务ID
     *
     * @param unstructure_id 非结构化任务ID
     */
    public void setUnstructure_id(String unstructure_id) {
        this.unstructure_id = unstructure_id;
    }
