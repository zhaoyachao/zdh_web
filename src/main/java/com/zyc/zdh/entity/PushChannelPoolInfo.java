...
@Table(name = "push_channel_pool_info")
public class PushChannelPoolInfo {
    @Id
    private String id;
     ...
     * 获取池配置
     *
     * @return pool_config - 池配置
     */
    public String getPool_config() {
        return pool_config;
    }
     ...
     * 设置池配置
     *
     * @param pool_config 池配置
     */
    public void setPool_config(String pool_config) {
