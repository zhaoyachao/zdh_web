...
public class CommonTreeInfo {
    ...
    public static CommonTreeInfo build(String id, String parent, String text, String level){
        CommonTreeInfo commonTreeInfo = new CommonTreeInfo();
        commonTreeInfo.setId(id);
        commonTreeInfo.setParent(parent);
        commonTreeInfo.setText(text);
        commonTreeInfo.setLevel(level);

        return commonTreeInfo;
