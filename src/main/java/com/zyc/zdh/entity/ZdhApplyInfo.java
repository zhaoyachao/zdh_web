...
public class ZdhApplyInfo extends ZdhBaseInfo{
    ...
    //etl 任务
    private EtlApplyTaskInfo etlApplyTaskInfo;
    ...
    public EtlApplyTaskInfo getEtlApplyTaskInfo() {
        return etlApplyTaskInfo;
    }

    public void setEtlApplyTaskInfo(EtlApplyTaskInfo etlApplyTaskInfo) {
        this.etlApplyTaskInfo = etlApplyTaskInfo;
    }
    ...
    public void setZdhApplyInfo(DataSourcesInfo dataSourcesInfoInput , EtlApplyTaskInfo etlApplyTaskInfo, DataSourcesInfo dataSourcesInfoOutput,TaskLogInstance tli){
        ...
        dsi_Input.setDbtable(etlApplyTaskInfo.getData_sources_table_name_input());
        ...
        dsi_Input.setPaths(etlApplyTaskInfo.getData_sources_file_name_input());
        this.dsi_Input=dsi_Input;
        ...
        dsi_Output.setDbtable(etlApplyTaskInfo.getData_sources_table_name_output());
        ...
        dsi_Output.setPaths(etlApplyTaskInfo.getData_sources_file_name_output());
