...
import com.zyc.notscan.base.BaseApprovalAuditorMapper;
 ...
 * @Description: TODO  
 */
public interface ApprovalAuditorMapper extends BaseApprovalAuditorMapper<ApprovalAuditorInfo> {
    ...
    @Select({
            ...
            " AND config.product_code=#{product_code}",
            "</when>",
