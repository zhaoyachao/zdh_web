...
//		Map<String, Object> getObj = JsonUtil.createEmptyMap();
//
...
//		List<Map<String, Object>> jsonarray = JsonUtil.toJavaListMap(aoData);
//
...
//			Map<String, Object> obj = jsonarray.get(i);
//			if (obj.get("name").equals("sEcho")) {
//                sEcho = obj.get("value").toString();
//            }
//
//			if (obj.get("name").equals("iDisplayStart")) {
//                iDisplayStart = Integer.valueOf(obj.getOrDefault("value", "0").toString());
//            }
//
//			if (obj.get("name").equals("iDisplayLength")) {
//                iDisplayLength = Integer.valueOf(obj.getOrDefault("value", "0").toString());
//            }
//
//			if (obj.get("name").equals("iSortCol_0")) {
//                t.setSortColumn(getSortColumn(ProductInfo.class,
//						Integer.valueOf(obj.getOrDefault("value", "0").toString())));
//            }
//
