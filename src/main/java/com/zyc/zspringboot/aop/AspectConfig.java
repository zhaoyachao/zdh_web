...
public class AspectConfig implements Ordered{
	...
	@Pointcut("execution(* com.zyc.zspringboot.quartz..*(..))")
	public void pointcutMethod(){}
	//在方法上的自定义注解使用@annotation,类上自定义注解使用@within(com.zyc.springboot.类名)
	@Pointcut("@annotation(com.zyc.zspringboot.aop.Log)")
	public void pointcutMethod2(){}
	@Pointcut("execution(* com.zyc.zspringboot.service.impl.RoleServiceImpl.*(..))")
