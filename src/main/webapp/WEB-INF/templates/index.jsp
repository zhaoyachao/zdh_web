...
<aside class="Hui-aside">
	...
	<dl id="menu-resume">
			...
			<dd>
				<ul>
					<li><a data-href="resume/myresume.do" data-title="我的简历" href="javascript:void(0)">我的简历</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="article/index.do" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="picture/list.do" data-title="图片管理" href="javascript:void(0)">图片管理</a></li>
						<li><a data-href="picture/build.do" data-title="生成二维码" href="javascript:void(0)">生成二维码</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/product/list.do" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="system/role?pageNum=1&&pageSize=5" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					...
					<li><a data-href="system/index" data-title="系统日志" href="javascript:void(0)">系统日志</a></li>
				</ul>
			</dd>
		</dl>
	</div>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				 <li class="active">
					<span title="我的桌面" data-href="main/welcome.jsp">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="getWelcome.do"></iframe>
	</div>
</div>
</section>
