  ...
  (function() {
      ...
      $('#add').click(function () {
          parent.layer.open({
              ...
              area : ['45%', '60%'],
              //area: ['450px', '500px'],
              content: server_context+"/data_tag_add_index?id=-1", //iframe的url
              end : function () {
                  console.info("弹框结束");
      ...
      function deleteMs(ids) {
          $.ajax({
              url : server_context+"/data_tag_delete",
              data : "ids=" + ids,
              type : "post",
              async:false,
              dataType : "json",
      ...
      window.operateEvents = {
          'click #edit': function (e, value, row, index) {
              ...
              parent.layer.open({
                  ...
                  area : ['45%', '60%'],
                  //area: ['450px', '500px'],
                  content: server_context+"/data_tag_add_index.html?id="+ row.id, //iframe的url
                  end : function () {
                      console.info("弹框结束");
                      $('#exampleTableEvents-table').bootstrapTable('destroy');
                      $('#exampleTableEvents').bootstrapTable('refresh', {
