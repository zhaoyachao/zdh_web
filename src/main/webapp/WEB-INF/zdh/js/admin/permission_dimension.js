  ...
  (function() {
      ...
      $('#add').click(function () {
          parent.layer.open({
              ...
              area : ['45%', '60%'],
              //area: ['450px', '500px'],
              content: server_context+"/permission_dimension_add_index?id=-1", //iframe的url
              end : function () {
                  console.info("弹框结束");
                  $('#exampleTableEvents-table').bootstrapTable('destroy');
                  $('#exampleTableEvents').bootstrapTable('refresh', {
                      url: server_context+"/permission_dimension_list?"+$("#permission_dimension_form").serialize()+"&tm="+new Date(),
      ...
      window.operateEvents = {
          'click #edit': function (e, value, row, index) {
              ...
              parent.layer.open({
                  ...
                  area : ['45%', '60%'],
                  //area: ['450px', '500px'],
                  content: server_context+"/permission_dimension_add_index.html?id="+ row.id, //iframe的url
                  end : function () {
                      console.info("弹框结束");
                      $('#exampleTableEvents-table').bootstrapTable('destroy');
                      $('#exampleTableEvents').bootstrapTable('refresh', {
          ...
          'click #edit_value': function (e, value, row, index) {
              ...
              parent.layer.open({
                  ...
                  area : ['100%', '100%'],
                  //area: ['450px', '500px'],
                  content: server_context+"/permission_dimension_value_index.html?id="+ row.id, //iframe的url
                  end : function () {
                      console.info("弹框结束");
                      $('#exampleTableEvents-table').bootstrapTable('destroy');
                      $('#exampleTableEvents').bootstrapTable('refresh', {
      ...
      var bootstrapTableConf = getTablePageCommon(server_context+"/permission_dimension_list?"+$("#permission_dimension_form").serialize()+"&tm="+new Date());
