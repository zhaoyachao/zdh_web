...
(function(document, window, $) {
  ...
  (function() {
      ...
      function deleteMs(ids) {
          $.ajax({
              url : server_context+"/beacon_fire_alarm_group_delete",
              data : "ids=" + ids,
              type : "post",
              async:false,
              dataType : "json",
              success : function(data) {
                  ...
                  $('#exampleTableEvents').bootstrapTable('refresh', {
                      url: server_context+"/beacon_fire_alarm_group_list?"+$("#etl_task_form").serialize(),
                      contentType: "application/json;charset=utf-8",
                      dataType: "json"
                  });
              },
      ...
      window.operateEvents = {
          'click #edit': function (e, value, row, index) {
              ...
              top.layer.open({
                  ...
                  area : ['45%', '60%'],
                  //area: ['450px', '500px'],
                  content: server_context+"/beacon_fire_alarm_group_add_index?id="+row.id, //iframe的url
                  end:function () {
                      $('#exampleTableEvents').bootstrapTable('refresh', {
                          url : server_context+'/beacon_fire_alarm_group_list'
                      });
                  }
              });
          ...
          'click #copy': function (e, value, row, index) {
              ...
              top.layer.open({
                  ...
                  area : ['45%', '60%'],
                  //area: ['450px', '500px'],
                  content: server_context+"/beacon_fire_alarm_group_add_index?id="+row.id+"&is_copy=true", //iframe的url
                  end:function () {
                      $('#exampleTableEvents').bootstrapTable('refresh', {
                          url: server_context+"/beacon_fire_alarm_group_list?"+$("#etl_task_form").serialize(),
                          contentType: "application/json;charset=utf-8",
      ...
      icons: {
        ...
        columns: [{
            ...
            field: 'alarm_group_context',
            title: '告 警 说 明',
            sortable:false
        },{
            field: 'alarm_group_code',
            title: '告 警 code',
            sortable:false
        },{
            field: 'create_time',
