  ...
  (function() {
      ...
      function operateFormatter(value, row, index) {
          return [
              ...
              '                                    </button>',
              ' <button id="push_template_execute" name="push_template_execute" type="button" class="btn btn-outline btn-sm" title="执行策略"><i class="glyphicon glyphicon-refresh" aria-hidden="true"></i>\n' +
              '                                    </button>'
               +
              '</div>'
