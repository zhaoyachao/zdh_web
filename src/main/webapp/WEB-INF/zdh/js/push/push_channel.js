  ...
  (function() {
      ...
      function operateFormatter(value, row, index) {
          ...
          return [
              ...
              '                                    </button>',
              ' <button id="push_channel_execute" name="push_channel_execute" type="button" class="'+edit_class+'" title="执行策略"><i class="glyphicon glyphicon-refresh" aria-hidden="true"></i>\n' +
              '                                    </button>'
               +
              '</div>'
